    ...
    _createClass(WebAudio, [{
        ...
        value: function createScriptNode() {
            if (this.params.audioScriptProcessor) {
                return this.params.audioScriptProcessor;
            }

            if (this.ac.createScriptProcessor) {
                var scriptNode = this.ac.createScriptProcessor(this.scriptBufferSize);
                console.warn('WARNING: ScriptProcessorNode is deprecated and will be removed. Please use AudioWorkletNode instead.');
                return scriptNode;
            }
            throw new Error('WebAudio API has no support for ScriptProcessorNode or AudioWorkletNode');
        }

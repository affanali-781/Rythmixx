      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <Stack spacing={2}>
          <Controller
            ...
            name="email"
            render={({ field }) => (
              <FormControl error={Boolean(errors.email)} sx={{backgroundColor: '#1a1a1a', color: 'text.secondary'}}>
          ...
          />
          {errors.root ? <Alert color="error" sx={{backgroundColor: '#1a1a1a', color: 'text.secondary'}}>{errors.root.message}</Alert> : null}

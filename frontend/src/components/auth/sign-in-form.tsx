...
export function SignInForm(): React.JSX.Element {
  ...
  return (
    <Stack spacing={4}>
      <Stack spacing={1}>
        <Typography variant="h4" color="white">Sign in</Typography>
          ...
          <Controller
            ...
            render={({ field }) => (
              <FormControl error={Boolean(errors.password)}>
                ...
                <OutlinedInput
                  {...field}
                  sx={{color: 'text.secondary', backgroundColor: '#1a1a1a'}}
                  endAdornment={
                    showPassword ? (
                      <EyeIcon
                        cursor="pointer"
      ...
      {/* <Alert color="warning" sx={{backgroundColor: '#1a1a1a', color: 'text.secondary'}}>
        Use{' '}

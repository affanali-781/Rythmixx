...
export default function GenMusicPage() {
    ...
    return (
        <Box sx={{ p: 3, bgcolor: 'black', minHeight: '100vh' }}>
  <form onSubmit={handleSubmit}>
    <Card sx={{
      backgroundColor: '#121212',  // dark grayish black (easier on eyes than pure black)
      borderRadius: '20px',
      ...
      <CardHeader
        title={
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
            <MusicNotes size={32} />
            <Typography variant="h4" sx={{ color: 'white' }}>Generate Music</Typography>
          </Box>
        }
      />
      <CardContent>
      ...
      {audioUrl && (
        <CardContent>
          <Typography variant="h6" gutterBottom sx={{ color: 'white' }}>Generated Music:</Typography>
